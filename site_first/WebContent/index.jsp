                ...
                <div class="left_col scroll-view">
                           ...
                           <!--   <h3>Live On</h3> -->
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-bar-chart-o"></i> Analyse personnalisée <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                         <li><a href="echarts.html">Analyse personnalisée</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="sidebar-footer hidden-small">
                     <!--    <a data-toggle="tooltip" data-placement="top" title="Settings">
                        ...
                        <a data-toggle="tooltip" data-placement="top" title="Grand écran">
                                ...
                                <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                                    <li>
                                        ...
                                        <span>Directeur automobile</span>
                                            ...
                                            <span class="message">
                                        Taux de réglement est inférieure de 25% 
                                    </span>
                                        </a>
                                    </li>
                                    <li>
            ...
            <div class="right_col" role="main">
             ...
             <div class="row">
                                      ...
                                      -->
                                       ...
                                       <!--  <td>
                                            <table class="tile_info">
                                                <tr>
                                                    <td>
                                                        <p><i class="fa fa-square blue"></i>Déclarés</p>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p><i class="fa fa-square aero"></i>Déclarés</p>
                                                    </td>
                                                   
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p><i class="fa fa-square red"></i>Classé sans suite</p>
                                                    </td>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Evolution montant réglement sinistre  <!-- <small>Sessions</small>  -->
                                    </h2>
                                   <ul class="nav navbar-right panel_toolbox">
                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                    </li>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Lieu sinistre <small>Algérie</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                    </li>
                                    <li class="dropdown">
